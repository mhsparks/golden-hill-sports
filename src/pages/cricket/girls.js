            ...
            <div class="columns">
              <div class="column is-two-thirds">
                <div class="card-content">
                  ...
                  <p>
                    As enthusiastic parents we started Girls cricket in 2016
                    and​​ we have seen the girls really develop as
                    personalities, gaining confidence and leadership through
                    playing cricket. <br />
                    ​​
                    <br />
                    Girls Cricket at Golden Hill really helps maintain
                    friendships from Junior School age right through to Senior
                    School. ​​​​ The cricket​​ encourages girls to be active and
                    enjoy sport and allows them to bond with a fantastic team
                    spirit.​​ We introduce the girls to​​ cricket from year 3
                    and this through soft ball cricket playing kwik cricket
                    games and exercises. ​​ Everyone is involved and there is no
                    kit requirement. ​​ It is all about fun and enjoyment. We
                    provide girls cricket from year 3 right through to Womens
                    Cricket. ​​​​ At the end of the 2019 season we had 75 girls
                    and 20 women registered and each year this increases with a
                    new intake of year 3 and 4 girls.
                    <br />
                    <br />
                    ...
                    which typically starts in late January through to
                    July/August – some years games in September.
                    <br />
                    <a
                    ...
                    Taster sessions​​ - anyone joining us for the first time is
                    of course welcome and the first few weeks are free taster
                    sessions. ​​​​ Should you wish to join there is a
                    registration fee in addition to the annual subscription
                    which covers the cost of the coloured kit.
                    <br />
                    <br />
                    <p class="has-text-primary has-text-weight-bold">
                      Waiting List
                    ...
                    7YA.
                    <br />
                    Please note that there is​​ also an entrance gate at the top
                    of Henleaze Park Drive.
                    <br />
                    <br />
                    <p class="has-text-primary has-text-weight-bold">
              ...
              <div class="column">
                ...
                <div class="card">
                  <div class="card-image">
                    <figure class="image">
                      <Img fluid={data.girlshome10.childImageSharp.fluid} />
                    </figure>
                  </div>
                </div>
                <div class="column"></div>
...
export const query = graphql`
  query {
    ...
    girlshome10: file(relativePath: { eq: "girls-gallery-10.jpg" }) {
      childImageSharp {
        fluid(maxWidth: 960) {
          ...GatsbyImageSharpFluid
        }
