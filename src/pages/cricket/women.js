            ...
            <div class="container">
              <div class="card-content">
                <p>
                  ...
                  Women’s T20 Development League in 2011, and changed to playing
                  in the Women’s T20 Competitive League in 2013. This league
                  covers an area from Bristol up to Hereford, although this has
                  changed to split into North and South areas as more women’s
                  teams are formed and join the leagues. <br />
                  We still organise the odd friendly with some of the teams in
                  the North league, as we love playing them, (and they do great
                  cake!)
                  <br />
                  <br />
                  ...
                  bring it along to use. Note that spikes are not allowed in the
                  nets.
                  <br />
                  <br />
                  ...
                  ladies cricket team, we would love to have you join us. You
                  can either contact Jan by emailing{" "}
                  <a
                  ...
                  cricket is for you – no obligation, we are happy for you to
                  give it a try.
                  <br />
                  <br /> New players are always welcome, no matter how
                  experienced you are. We have a range of abilities from
                  complete beginners to those that have played a bit! We are a
                  fun and friendly team, who are still learning from each other,
                  and enjoying those summer afternoons of cricket in the
                  pleasant surroundings of the Golden Hill Sports ground.
                  Matches are on Sundays with various start times, both home and
                  away, and we provide teas for weekend home matches. We also
                  have the occasional mid-week match on our Wednesday training
                  night. <br />
                  <br />
                </p>
                <br />
